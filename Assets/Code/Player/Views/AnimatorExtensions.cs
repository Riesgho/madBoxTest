...
{
    public static IObservable<Unit> WaitUntilAnimationIsPlayedObservable(this Animator animator, int state,
        int layerIndex = 0)
    {
    ...
    public static IObservable<Unit> WaitUntilAnimationEndsAsObservable(this Animator animator, int[] states,
        int layerIndex = 0, float normalizedTimeOffset = 0f)
    {
